...
Patch0: tclx-varinit.patch
Patch1: tclx-man.patch
...
echo '%{_libdir}/tcl%{upversion}/%{name}%{major_ver}' > $RPM_BUILD_ROOT%{_sysconfdir}/ld.so.conf.d/%{name}-%{_arch}.conf

%files
%doc ChangeLog README
%{_libdir}/tcl%{upversion}/%{name}%{major_ver}/
...
* Tue Sep 29 2008 Marcela Mašlá�ová <mmaslano@redhat.com> - 8.4.0-12
